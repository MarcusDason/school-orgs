      ...
      {canPost && (
        <div className="p-4 space-y-3">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 rounded border dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
